...
import com.mandiri.moviesapp.data.movies.remote.MoviesService
import com.mandiri.moviesapp.network.NetworkConnectionInterceptor
...
class NetworkModule {
    ...
    @Provides
    fun provideMoviesService(@Named(RETROFIT) retrofit: Retrofit): MoviesService {
